...
#define SYMB_POWER_CFG_REG     DDRB
...
#define SYMB_POWER_CFG_IND     DDB1
...
#define SYMB_480_OUT_EN          (SYMB_480_i_CFG_REG |= (1 << SYMB_480_CFG_IND))
#define SYMB_480_i_OUT_EN        (SYMB_480_p_CFG_REG |= (1 << SYMB_480_i_CFG_IND))
#define SYMB_480_p_OUT_EN        (SYMB_480_p_PORT |= (1 << SYMB_480_p_CFG_IND))
